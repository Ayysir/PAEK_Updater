...
import com.ayysir.paek.adapter.CPUPagerAdapter;
import com.ayysir.paek.tools.Constants;

import java.lang.reflect.Field;

public class CPUHostFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_cpuhost, container, false);

        if (rootView != null) {
            ViewPager viewPager = (ViewPager) rootView.findViewById(R.id.pager2);

            // Set the OverViewPagerAdapter into ViewPager
            viewPager.setAdapter(new CPUPagerAdapter(getChildFragmentManager()));
        }
